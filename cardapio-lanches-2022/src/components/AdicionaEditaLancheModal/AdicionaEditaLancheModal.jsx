...
function AdicionaEditaLancheModal({
  closeModal,
  onCreateLanche,
  mode,
  lancheToUpdate,
    ...
    <Modal closeModal={closeModal}>
      <div className="AdicionaLancheModal">
        <form autoComplete="off">
          ...
          <div>
            <label className="AdicionaLancheModal__text" htmlFor="local">
              {" "}
              Local:{" "}
            </label>
            <input
          ...
          <div>
            <label className="AdicionaLancheModal__text" htmlFor="localizacao">
              {" "}
              Localização:{" "}
            </label>
            <input
          ...
          <div>
            <label className="AdicionaLancheModal__text" htmlFor="descricao">
              {" "}
              Descricao:{" "}
            </label>
            <input
